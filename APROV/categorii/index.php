...
<body>
    ...
    <form action="./adauga_categorie.php" method="POST">
        ...
        <button type="submit" name="actionare">Adauga</button>
    </form>
    ...
    <form action="./sterge_categorie.php" method="GET">
        ...
        <button type="submit" name="actionare">Sterge</button>
    </form>
